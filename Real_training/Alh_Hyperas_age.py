...
def create_model(normed_train_data, normed_test_data, train_labels, test_labels):
  ...
  model.add(layers.Reshape((23, 1))) #reshape for use in CNN
  # CNN layers
...
def data():
  ...
  train_labels = (train_labels - stats[-2, 0]) / stats[-2, 1] #normalise ages
  test_labels = (test_labels - stats[-2, 0]) / stats[-2, 1] 
